...
---
${await this.stampManager.stampContent('')}`;

        await forge.addPRComment(prNumber, body);
...
${await this.stampManager.stampContent('')}`;
    ...
    async postIteration(
        ...
        const body = `## 🔧 Coding Iteration ${iteration.iteration}
...
${await this.stampManager.stampContent('')}`;
    ...
    async postCompetitiveAnalysis(
        ...
        const body = `## ⚔️ Competitive PR Analysis
